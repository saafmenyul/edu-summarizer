...
- **Workflow dispatch**: Ручной запуск с параметрами (выбор языка и версии Python)
- **Artifact upload**: Сохранение результатов тестов и отчетов (доступны 30-90 дней)
- **Daily reports**: Автоматическая генерация ежедневных отчетов о статусе проекта

Подробная документация по CI/CD: [docs/CI_CD.md](docs/CI_CD.md)
